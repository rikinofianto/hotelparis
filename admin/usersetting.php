        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 )
											{
												echo"<tr class='gradeC'>
													...
													<td><a href=usersettingdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Hapus</button></td>
												</tr>";
											}
											else
											{
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <label>Tambah Usernme baru</label>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           ...
                                           <input type="submit" name="up" value="Ubah" class="btn btn-primary">
										  </form>
				...
				if(isset($_POST['up']))
				{
					...
					{
					echo' <script language="javascript" type="text/javascript"> alert("Username dan Password telah diubah") </script>';
