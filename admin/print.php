...
@page { margin: 0; }
	...
	$sql ="select * from pembayaran where id = '$pid' ";
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$tipe_tempat_tidur = $row['tipe_tempat_tidur'];
		...
		$jml_hari = $row['jml_hari'];
									...
									else if($tipe_tempat_tidur=="Double")
									{
										$type_of_bed = $type_of_room * 2/100;
									}
									else if($tipe_tempat_tidur=="Triple")
									{
										$type_of_bed = $type_of_room * 3/100;
									}
									else if($tipe_tempat_tidur=="Quad")
									{
										$type_of_bed = $type_of_room * 4/100;
									}
									else if($tipe_tempat_tidur=="None")
									{
										$type_of_bed = $type_of_room * 0/100;
									}

									if($makanan=="Hanya Kamar")
									{
										$type_of_meal=$type_of_bed * 0;
									}
									else if($makanan=="Sarapan")
									{
										$type_of_meal=$type_of_bed * 2;
									}else if($makanan=="Half Board")
									{
										$type_of_meal=$type_of_bed * 3;

									}else if($makanan=="Lengkap")
									{
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>QUEEN OF THE SOUTH,</p>
				<p>Parangtritis Bantul,<br>Yogyakarta,<br>Indonesia</p>
				<p>+(62) 274 - 367136</p>
			</address>
		...
		<article>
			<h1>Recipient</h1>
			<address >
				<p><?php echo $title.' '.$nama_depan." ".$nama_belakang ?> <br></p>
			</address>
			<table class="meta">
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :-  reservation@queenofthesouth-resort.com || Web :- www.QueenOfthesouth.com || Phone :- +(62) 274 - 367136 </p>
			</div>
		</aside>
	</body>
</html>
...
$free="Gratis";
$nul = null;
$rpsql = "UPDATE `kamar` SET `tempat`='$free',`cusid`='$nul' where `cusid`='$id'";
if(mysqli_query($con,$rpsql))
{
	$delsql= "DELETE FROM `pesan_kamar` WHERE id='$id' ";
